...
hold on ;
 ...
 plot(X3,'g--^');
 grid on;
 title('MTTR Vs SU for different number of radio');
 xlabel('SU');
 ylabel('MTTR');
...
hold on ;
 ...
 %*******************************************************************************************
 TTRVsSU2 = csvread('Average TTR VS SU(0.2).csv');
 TTRVsSU4 = csvread('Average TTR VS SU(0.4).csv');
 TTRVsSU6 = csvread('Average TTR VS SU(0.6).csv');
 ...
 xlabel('SU');
 ylabel('TTR');
 legend('PU Prob 0.2', 'PU Prob 0.4', 'PU Prob 0.6');
